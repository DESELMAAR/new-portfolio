  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      {isLoading ? (
        ...
        // Actual content
        <div className="text-center p-4 w-full mt-10">
          ...
          {/* Skills List */}
          <div className="grid grid-cols-4 max-md:grid-cols-1 w-full justify-center ">
            {/* Category 1 */}
            <div
            ...
            >
              <ul className="grid  grid-cols-1  opacity-85 overflow-hidden scrollbar-hide">
                {filteredSkills
                  .filter((skill) => skill.category == 1) // Filter skills where category is 1
                  .map((skill) => (
                    <li key={skill.id} className="font-semibold text-slate-900">
                     {skill.name}
                      {localStorage.getItem("token") && (
                        <button
            ...
            {/* Category 2 */}
            <div className=" m-4 p-6 rounded-lg shadow-lg"
              style={{
                background: "rgba(255, 255, 255, 0.3)", // Semi-transparent white background
                backdropFilter: "blur(10px)", // Blur effect for the glassy look
                border: "1px solid rgba(255, 255, 255, 0.2)", // Light border for depth
              ...
              <ul className="grid  grid-cols-1 rounded-lg  opacity-85 overflow-hidden scrollbar-hide">
                {filteredSkills
